...
--INSERTAMOS DATOS DEL TIPO DE RESERVA
INSERT INTO TIPO_RESERVA VALUES('PRESENCIAL')
INSERT INTO TIPO_RESERVA VALUES('VIRTUAL')

--INSERTAMOS DATOS DEL ESTADO DE RESERVA
INSERT INTO ESTADO_RESERVA VALUES('PENDIENTE')
INSERT INTO ESTADO_RESERVA VALUES('CONFIRMADA')
INSERT INTO ESTADO_RESERVA VALUES('CANCELADA')
INSERT INTO ESTADO_RESERVA VALUES('EN PROCESO')



-- INSERTAR DATOS EN LA TABLA CON INSERT INTO
EXEC SP_Ingreso_Reserva 2,1,'2022-12-25',1,'El usuario solicitó el libro para su trabajo de investigación',3
EXEC SP_Ingreso_Reserva 3,1,'2022-10-26',1,'El usuario necesita tenerlo lo antes posible',4
EXEC SP_Ingreso_Reserva 5,2,'2021-01-27',3,'El usuario puede que cancele la reserva',3
EXEC SP_Ingreso_Reserva 10,1,'2021-12-28',2,'El usuario los necesita para una tesis',2
EXEC SP_Ingreso_Reserva 11,1,'2021-07-29',2,'Puede llamar a que se haga entrega a domicilio',2
EXEC SP_Ingreso_Reserva 15,2,'2021-02-25',2,'Sin ninguna observacion',3
EXEC SP_Ingreso_Reserva 4,1,'2021-09-21',1,'Sin ninguna observacion',3
EXEC SP_Ingreso_Reserva 6,2,'2021-03-21',1,'El usuario vendra 1 hora antes del termino de la reserva',2
EXEC SP_Ingreso_Reserva 7,1,'2021-01-05',2,'Sin ninguna observacion',3
EXEC SP_Ingreso_Reserva 21,2,'2021-02-06',2,'Sin ninguna observacion',2


--DATOS DE LA TABLA DETALLE_RESERVA

INSERT INTO DETALLE_RESERVA VALUES(5,1,1)
INSERT INTO DETALLE_RESERVA VALUES(6,1,1)
INSERT INTO DETALLE_RESERVA VALUES(7,1,1)

INSERT INTO DETALLE_RESERVA VALUES(22,2,1)
INSERT INTO DETALLE_RESERVA VALUES(23,2,1)
INSERT INTO DETALLE_RESERVA VALUES(24,2,1)
INSERT INTO DETALLE_RESERVA VALUES(25,2,1)

INSERT INTO DETALLE_RESERVA VALUES(20,3,2)
INSERT INTO DETALLE_RESERVA VALUES(21,3,1)

INSERT INTO DETALLE_RESERVA VALUES(28,4,1)
INSERT INTO DETALLE_RESERVA VALUES(38,4,1)

INSERT INTO DETALLE_RESERVA VALUES(26,5,2)

INSERT INTO DETALLE_RESERVA VALUES(31,6,2)
INSERT INTO DETALLE_RESERVA VALUES(36,6,1)

INSERT INTO DETALLE_RESERVA VALUES(3,7,2)
INSERT INTO DETALLE_RESERVA VALUES(4,7,1)

INSERT INTO DETALLE_RESERVA VALUES(10,8,1)
INSERT INTO DETALLE_RESERVA VALUES(11,8,1)

INSERT INTO DETALLE_RESERVA VALUES(20,9,1)
INSERT INTO DETALLE_RESERVA VALUES(21,9,2)
...
EXEC SP_InsertarDetalleMulta '001' , 1, 'PAGADA'
