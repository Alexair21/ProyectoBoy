...
(
	CPO_Id               int IDENTITY ( 1,1 ) ,
	CPO_Monto            money  NOT NULL ,
	CPO_Fecha            date  NOT NULL ,
	CPO_Foto             varchar(100)  NOT NULL
)
go
...
ALTER TABLE COMPROBANTES_PAGO
	ADD CONSTRAINT XPKCOMPROBANTES_PAGO PRIMARY KEY  CLUSTERED (CPO_Id ASC)
go
...
ALTER TABLE CARNETS
	ADD CONSTRAINT R_37 FOREIGN KEY (USR_Id) REFERENCES USUARIOS(USR_Id)
		ON DELETE NO ACTION
		ON UPDATE NO ACTION
go
...
ALTER TABLE FICHAS_INSCRIPCION
	ADD CONSTRAINT R_51 FOREIGN KEY (CPO_Id) REFERENCES COMPROBANTES_PAGO(CPO_Id)
		ON DELETE NO ACTION
		ON UPDATE NO ACTION
go
...
ALTER TABLE MULTAS
	ADD CONSTRAINT R_48 FOREIGN KEY (CPO_Id) REFERENCES COMPROBANTES_PAGO(CPO_Id)
		ON DELETE NO ACTION
		ON UPDATE NO ACTION
go
